...
public class PictureDescriptionResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picture_description_result);
    ...
    private void initializeViews() {
        ...
        btnRetry.setOnClickListener(v -> {
            startActivity(new Intent(this, PictureDescriptionActivity.class));
            finish();
        });
    ...
    private void displayResults() {
        ...
        scoreContainer.setBackgroundColor(backgroundColor);
    }
